            ...
            <Modal open={modal}>
              ...
              <div className='foto-imort'>
                ...
                <form action="" className='form-foro-import' onSubmit={handelSubmit}>
                  <label className="form-label input-foto" forHTML="customFile">Загрузите фотографию</label>
                  ...
                  {selectedForm == 1 ? (
                    <>
                      <label className="form-label input-foto" forHTML="customFile">Присутствует модель</label>
                      <label forHTML="customFile1">

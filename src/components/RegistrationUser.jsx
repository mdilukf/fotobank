...
export default function Registration (){
  ...
  let [authMode, setAuthMode] = useState("signin")
    ...
    return(
        <>
        <TabButtonUser active={tab} onChenge={(current) => setTab(current)} className='justify-content: center mt-5' />
                  {tab == 'main' && (
                    <>
                      <section>
                        <div className="Auth-form-container">
                          <form className="Auth-form">
                            <div className="Auth-form-content">
                              <h3 className="Auth-form-title">Пользователь зарегистрированн. Пройтите авторизацию</h3>
